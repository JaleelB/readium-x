...
export function SignUpForm() {
  ...
  if (!isUserLoaded || isSignedIn) {
    return (
      <div className="dark relative flex h-full min-h-screen w-full items-center justify-center bg-background">
        <SparkleBg sparkleCount={120} sparkleSize={2} />
        <p className="z-20 text-sm text-muted-foreground">Redirecting...</p>
      </div>
    );
  }
