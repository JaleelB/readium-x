...
export function BookmarksSearchBox({
  ...
  return (
    <div className="relative">
      ...
      <Input
        ref={inputRef}
        className="w-full justify-start whitespace-nowrap rounded-[0.5rem] border border-input bg-muted/50 px-10 py-2 text-sm font-normal text-muted-foreground shadow-none transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
        placeholder="Search..."
        value={value}
        onChange={(e) => {
